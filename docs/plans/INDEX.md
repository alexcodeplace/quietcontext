...
| COMPLETE | [QC semantic review, landing, and local deployment](2026-09-18-qc-semantic-review-land-deploy.md) | Reviewed runtime landed, pinned by Overdeck, and live locally at exact QC `dd0d9aee` |
| ACTIVE | [QC agent adoption front-load](2026-09-18-qc-agent-adoption-frontload.md) | external graph-tool style prompt front-load + repo explore + measurable adoption |
