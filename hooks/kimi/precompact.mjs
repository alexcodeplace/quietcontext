...
// Diagnostic log is opt-in via QUIET_CONTEXT_DEBUG. Long-running installs hit
...
const DEBUG_LOG = process.env.QUIET_CONTEXT_DEBUG
...
try {
  ...
  // Without QUIET_CONTEXT_DEBUG, swallow silently — same shape as other hooks.
}
