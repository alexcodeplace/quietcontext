import{createRequire as ie}from"node:module";import{existsSync as ae,unlinkSync as B,renameSync as ce}from"node:fs";import{tmpdir as ue}from"node:os";import{join as de}from"node:path";var A=class{#e;#t=new Set;constructor(e){this.#e=e}pragma(e){let t=this.#e.prepare(`PRAGMA ${e}`);return this.#n(t,()=>{let n=t.all();if(!n||n.length===0)return;if(n.length>1)return n;let s=Object.values(n[0]);return s.length===1?s[0]:n[0]})}exec(e){let t="",n=null;for(let i=0;i<e.length;i++){let a=e[i];if(n)t+=a,a===n&&(n=null);else if(a==="'"||a==='"')t+=a,n=a;else if(a===";"){let c=t.trim();c&&this.#r(c),t=""}else t+=a}let s=t.trim();return s&&this.#r(s),this}prepare(e){let t=this.#e.prepare(e),n=!1,s=()=>{n||(t.finalize?.(),n=!0,this.#t.delete(s))};return this.#t.add(s),{run:(...i)=>t.run(...i),get:(...i)=>{let a=t.get(...i);return a===null?void 0:a},all:(...i)=>t.all(...i),iterate:(...i)=>t.iterate(...i),finalize:s}}transaction(e){return this.#e.transaction(e)}close(){let e=[];for(let t of Array.from(this.#t))try{t()}catch(n){e.push(n)}try{this.#e.close(!0)}catch(t){e.push(t)}if(e.length===1)throw e[0];if(e.length>1)throw new AggregateError(e,"Failed to close Bun SQLite database")}#r(e){let t=this.#e.prepare(e);this.#n(t,()=>t.run())}#n(e,t){let n,s,i=!1;try{n=t()}catch(a){i=!0,s=a}try{e.finalize?.()}catch(a){throw i?new AggregateError([s,a],"SQLite operation and cleanup failed"):a}if(i)throw s;return n}},w=class{#e;constructor(e){this.#e=e}pragma(e){let n=this.#e.prepare(`PRAGMA ${e}`).all();if(!n||n.length===0)return;if(n.length>1)return n;let s=Object.values(n[0]);return s.length===1?s[0]:n[0]}exec(e){return this.#e.exec(e),this}prepare(e){let t=this.#e.prepare(e);return{run:(...n)=>t.run(...n),get:(...n)=>t.get(...n),all:(...n)=>t.all(...n),iterate:(...n)=>typeof t.iterate=="function"?t.iterate(...n):t.all(...n)[Symbol.iterator]()}}transaction(e){return(...t)=>{this.#e.exec("BEGIN");try{let n=e(...t);return this.#e.exec("COMMIT"),n}catch(n){throw this.#e.exec("ROLLBACK"),n}}}close(){this.#e.close()}},m=null;function le(r){let e=null;try{return e=new r(":memory:"),e.exec("CREATE VIRTUAL TABLE __fts5_probe USING fts5(x)"),!0}catch{return!1}finally{try{e?.close()}catch{}}}function Ee(r,e){let t=e!==void 0?e:globalThis.Bun;if(typeof t<"u"&&t!==null)return!0;let n=r??process.versions,[s,i]=(n.node??"0.0.0").split("."),a=Number(s),c=Number(i);return!Number.isFinite(a)||!Number.isFinite(c)?!1:a>22||a===22&&c>=5}function ge(){if(!m){let r=ie(import.meta.url);if(globalThis.Bun){let e=r(["bun","sqlite"].join(":")).Database;m=function(n,s){let i=new e(n,{readonly:s?.readonly,create:!0}),a=new A(i);return s?.timeout&&a.pragma(`busy_timeout = ${s.timeout}`),a}}else if(Ee()){let e=null;try{({DatabaseSync:e}=r(["node","sqlite"].join(":")))}catch{e=null}e&&le(e)?m=function(n,s){let i=new e(n,{readOnly:s?.readonly??!1}),a=new w(i);return s?.timeout&&a.pragma(`busy_timeout = ${s.timeout}`),a}:m=r("better-sqlite3")}else m=r("better-sqlite3")}return m}function F(r){r.pragma("journal_mode = WAL"),r.pragma("synchronous = NORMAL");try{r.pragma("journal_size_limit = 67108864")}catch{}try{r.pragma("mmap_size = 268435456")}catch{}}function k(r){if(!ae(r))for(let e of["-wal","-shm"])try{B(r+e)}catch{}}function me(r){for(let e of["","-wal","-shm"])try{B(r+e)}catch{}}function I(r){try{r.pragma("wal_checkpoint(TRUNCATE)")}catch{}try{r.close()}catch{}}function P(r="context-mode"){return de(ue(),`${r}-${process.pid}.db`)}function _e(r,e=[100,500,2e3]){let t;for(let n=0;n<=e.length;n++)try{return r()}catch(s){let i=s instanceof Error?s.message:String(s);if(!i.includes("SQLITE_BUSY")&&!i.includes("database is locked"))throw s;if(t=s instanceof Error?s:new Error(i),n<e.length){let a=e[n],c=Date.now();for(;Date.now()-c<a;);}}throw new Error(`SQLITE_BUSY: database is locked after ${e.length} retries. Original error: ${t?.message}`)}function Te(r){return r.includes("SQLITE_CORRUPT")||r.includes("SQLITE_NOTADB")||r.includes("database disk image is malformed")||r.includes("file is not a database")}function pe(r){let e=Date.now();for(let t of["","-wal","-shm"])try{ce(r+t,`${r}${t}.corrupt-${e}`)}catch{}}var y=Symbol.for("__context_mode_live_dbs_v3__"),O=(()=>{let r=globalThis;return r[y]||(r[y]=new Set,process.on("exit",()=>{for(let e of r[y])I(e);r[y].clear()})),r[y]})(),R=class{#e;#t;constructor(e){let t=ge();this.#e=e,k(e);let n;try{n=new t(e,{timeout:3e4}),F(n)}catch(s){let i=s instanceof Error?s.message:String(s);if(Te(i)){pe(e),k(e);try{n=new t(e,{timeout:3e4}),F(n)}catch(a){throw new Error(`Failed to create fresh DB after renaming corrupt file: ${a instanceof Error?a.message:String(a)}`)}}else throw s}this.#t=n,O.add(this.#t),this.initSchema(),this.prepareStatements()}get db(){return this.#t}get dbPath(){return this.#e}close(){O.delete(this.#t),I(this.#t)}withRetry(e){return _e(e)}cleanup(){O.delete(this.#t),I(this.#t),me(this.#e)}};import{createHash as S}from"node:crypto";import{execFileSync as ye}from"node:child_process";import{accessSync as Se,constants as fe,existsSync as N,mkdirSync as he,realpathSync as ve,renameSync as U}from"node:fs";import{homedir as G}from"node:os";import{dirname as Re,isAbsolute as q,join as E,resolve as T}from"node:path";var l="QUIET_CONTEXT_DIR",Y="sessions",j="content",f=class extends Error{kind;path;overrideEnvVar;ignoredEnvVar;ignoredReason;constructor(e,t,n=l,s,i,a={}){super(i??De(e,t,a),{cause:s}),this.name="StorageDirectoryError",this.kind=e,this.path=t,this.overrideEnvVar=n,this.ignoredEnvVar=a.ignoredEnvVar,this.ignoredReason=a.ignoredReason}},L=new Map;function qe(r){let e=r.env??process.env,t=r.legacySessionDirEnv,n=t?e[t]?.trim():void 0;return n&&t?(r.onLegacySessionDir?.(t,n),n):E(be(r.configDir,r.configDirEnv,e),"context-mode","sessions")}function be(r,e,t){let n=e?t[e]:void 0;return n&&n.trim()!==""?H(n.trim()):H(r,G())}function H(r,e){return r.startsWith("~")?T(G(),r.replace(/^~[/\\]?/,"")):q(r)?T(r):e?T(e,r):T(r)}function Le(r,e,t){return new f(r,e,l,void 0,[`Invalid ${l} for context-mode ${r} directory: ${t}`,J()].join(`
`))}function K(r){let e=process.env[l];if(e===void 0)return{kind:"unset"};let t=e.trim();if(!t)return{kind:"ignored-empty",ignoredEnvVar:l,ignoredReason:"empty"};if(!q(t))throw Le(r,t,`${l} must be an absolute path.`);return{kind:"override",root:T(t)}}function Ne(r){return r.kind==="ignored-empty"?{ignoredEnvVar:r.ignoredEnvVar,ignoredReason:r.ignoredReason}:{}}function z(r,e){let t=K(r);return t.kind!=="override"?null:{kind:r,path:E(t.root,e),envVar:l,source:"override"}}function Ce(r,e,t){return{kind:r,path:T(e()),envVar:null,source:"default",...t}}function Q(r){let e=K("session");return e.kind==="override"?{kind:"session",path:E(e.root,Y),envVar:l,source:"override"}:Ce("session",r,Ne(e))}function Ye(r){let e=z("content",j);if(e)return e;let t=Q(r);return{kind:"content",path:E(Re(t.path),j),envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function Ke(r){let e=z("stats",Y);if(e)return e;let t=Q(r);return{kind:"stats",path:t.path,envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function ze(r){return r.message}function Qe(r){return r.source==="override"&&r.envVar?`via ${r.envVar}`:r.ignoredEnvVar&&r.ignoredReason==="empty"?`default; ignored empty ${r.ignoredEnvVar}`:"default"}function Je(){L.clear()}function Ze(r){let e=[r.kind,r.path,r.source,r.envVar??"",r.ignoredEnvVar??"",r.ignoredReason??""].join("\0"),t=L.get(e);if(t instanceof f)throw t;if(t===r.path)return t;try{return he(r.path,{recursive:!0}),Se(r.path,fe.W_OK),L.set(e,r.path),r.path}catch(n){let s=new f(r.kind,Ae(n)??r.path,l,n,void 0,{ignoredEnvVar:r.ignoredEnvVar,ignoredReason:r.ignoredReason});throw L.set(e,s),s}}function De(r,e,t={}){return[`context-mode ${r} directory is not writable: ${e}`,Oe(t),J()].filter(Boolean).join(`
`)}function Oe(r){return r.ignoredEnvVar&&r.ignoredReason==="empty"?`Ignored empty ${r.ignoredEnvVar}; using adapter default.`:null}function J(){return`Set ${l} to a writable absolute path.`}function Ae(r){if(!r||typeof r!="object")return null;let e=r.path;return typeof e=="string"&&e.length>0?e:null}var _;function g(r){let e=r.replace(/\\/g,"/");return/^\/+$/.test(e)?"/":/^[A-Za-z]:\/+$/.test(e)?`${e.slice(0,2)}/`:e.replace(/\/+$/,"")}function V(r){let e=r;try{e=ve.native(r)}catch{}let t=g(e);return process.platform==="win32"||process.platform==="darwin"?t.toLowerCase():t}function Z(r,e){return ye("git",["-C",r,...e],{encoding:"utf-8",timeout:2e3,stdio:["ignore","pipe","ignore"]}).trim()}function we(r){let e=Z(r,["rev-parse","--show-toplevel"]);return e.length>0?g(e):null}function Ie(r){let e=Z(r,["worktree","list","--porcelain"]).split(/\r?\n/).find(t=>t.startsWith("worktree "))?.replace("worktree ","")?.trim();return e?g(e):null}function Ue(r=process.cwd()){let e=process.env.QUIET_CONTEXT_SESSION_SUFFIX;if(_&&_.projectDir===r&&_.envSuffix===e)return _.suffix;let t="";if(e!==void 0)t=e?`__${e}`:"";else try{let n=we(r),s=Ie(r);if(n&&s){let i=V(n),a=V(s);i!==a&&(t=`__${S("sha256").update(i).digest("hex").slice(0,8)}`)}}catch{}return _={projectDir:r,envSuffix:e,suffix:t},t}function et(){_=void 0}function ee(r){return S("sha256").update(g(r)).digest("hex").slice(0,16)}function te(r){let e=g(r),t=process.platform==="darwin"||process.platform==="win32"?e.toLowerCase():e;return S("sha256").update(t).digest("hex").slice(0,16)}function tt(r){let{projectDir:e,contentDir:t}=r,n=te(e),s=E(t,`${n}.db`);if(N(s))return s;let i=ee(e);if(i===n)return s;let a=E(t,`${i}.db`);if(N(a))try{U(a,s);for(let c of["-wal","-shm"])try{U(a+c,s+c)}catch{}}catch{}return s}function rt(r){return xe({...r,ext:".db"})}function xe(r){let{projectDir:e,sessionsDir:t,ext:n}=r,s=r.suffix??Ue(e),i=te(e),a=E(t,`${i}${s}${n}`);if(N(a))return a;let c=ee(e);if(c===i)return a;let d=E(t,`${c}${s}${n}`);if(N(d))try{U(d,a)}catch{}return a}var W=1e3,X=5;function b(r){let e=Number(r);return!Number.isFinite(e)||e<=0?0:Math.floor(e)}var o={insertEvent:"insertEvent",getEvents:"getEvents",getEventsByType:"getEventsByType",getEventsByPriority:"getEventsByPriority",getEventsByTypeAndPriority:"getEventsByTypeAndPriority",getEventCount:"getEventCount",getLatestAttributedProject:"getLatestAttributedProject",checkDuplicate:"checkDuplicate",evictLowestPriority:"evictLowestPriority",updateMetaLastEvent:"updateMetaLastEvent",ensureSession:"ensureSession",getSessionStats:"getSessionStats",getSessionRollup:"getSessionRollup",getMaxFileEdits:"getMaxFileEdits",getLatestCommitMessage:"getLatestCommitMessage",incrementCompactCount:"incrementCompactCount",getUsageCursor:"getUsageCursor",setUsageCursor:"setUsageCursor",upsertResume:"upsertResume",getResume:"getResume",markResumeConsumed:"markResumeConsumed",claimLatestUnconsumedResume:"claimLatestUnconsumedResume",deleteEvents:"deleteEvents",deleteMeta:"deleteMeta",deleteResume:"deleteResume",getOldSessions:"getOldSessions",searchEvents:"searchEvents",incrementToolCall:"incrementToolCall",getToolCallTotals:"getToolCallTotals",getToolCallByTool:"getToolCallByTool",getEventBytesSummary:"getEventBytesSummary",deleteToolCalls:"deleteToolCalls",insertToolLedger:"insertToolLedger",deleteToolLedger:"deleteToolLedger",getToolLedgerSummary:"getToolLedgerSummary",insertBurstEvent:"insertBurstEvent",deleteBurstEvents:"deleteBurstEvents",getBurstEvents:"getBurstEvents"},Me=[["project_dir","TEXT NOT NULL DEFAULT ''"],["attribution_source","TEXT NOT NULL DEFAULT 'unknown'"],["attribution_confidence","REAL NOT NULL DEFAULT 0"],["bytes_avoided","INTEGER NOT NULL DEFAULT 0"],["bytes_returned","INTEGER NOT NULL DEFAULT 0"]];function re(r){let e=r.pragma("table_xinfo(session_events)"),t=new Set(e.map(s=>s.name)),n=!1;for(let[s,i]of Me)t.has(s)||(r.exec(`ALTER TABLE session_events ADD COLUMN ${s} ${i}`),n=!0);return n&&r.exec("CREATE INDEX IF NOT EXISTS idx_session_events_project ON session_events(session_id, project_dir)"),n}function nt(r,e){let t=null,n,s;try{t=new e(r),re(t)}catch(i){n=i}finally{try{t?.close()}catch(i){s=i}}if(s)throw n?new AggregateError([n,s],n instanceof Error?n.message:"Session-events migration and cleanup failed"):s}var $=class extends R{constructor(e){super(e?.dbPath??P("session"))}stmt(e){return this.stmts.get(e)}initSchema(){try{let t=this.db.pragma("table_xinfo(session_events)").find(n=>n.name==="data_hash");t&&t.hidden!==0&&this.db.exec("DROP TABLE session_events")}catch{}this.db.exec(`
    ...
    `);try{re(this.db)}catch{}try{this.db.pragma("table_xinfo(session_meta)").some(t=>t.name==="usage_cursor")||this.db.exec("ALTER TABLE session_meta ADD COLUMN usage_cursor TEXT")}catch{}}prepareStatements(){this.stmts=new Map;let e=(t,n)=>{this.stmts.set(t,this.db.prepare(n))};e(o.insertEvent,`INSERT INTO session_events (
       ...
       FROM tool_calls WHERE session_id = ? ORDER BY calls DESC`),e(o.getEventBytesSummary,`SELECT COALESCE(SUM(bytes_avoided), 0) AS bytes_avoided,
              COALESCE(SUM(bytes_returned), 0) AS bytes_returned
       FROM session_events WHERE session_id = ?`),e(o.deleteToolCalls,"DELETE FROM tool_calls WHERE session_id = ?"),e(o.insertToolLedger,`INSERT INTO tool_ledger (session_id, tool, working_root, bytes_returned, counterfactual_bytes)
       VALUES (?, ?, ?, ?, ?)`),e(o.deleteToolLedger,"DELETE FROM tool_ledger WHERE session_id = ?"),e(o.getToolLedgerSummary,`SELECT tool,
              COUNT(*) AS calls,
              COALESCE(SUM(bytes_returned), 0) AS bytes_returned,
              COALESCE(SUM(counterfactual_bytes), 0) AS counterfactual_bytes
       FROM tool_ledger WHERE session_id = ? GROUP BY tool`),e(o.insertBurstEvent,`INSERT INTO tool_burst_events (session_id, working_root, calls_in_burst, seconds_span)
       VALUES (?, ?, ?, ?)`),e(o.deleteBurstEvents,"DELETE FROM tool_burst_events WHERE session_id = ?"),e(o.getBurstEvents,`SELECT working_root, calls_in_burst, seconds_span, created_at
       FROM tool_burst_events WHERE session_id = ? ORDER BY id ASC`)}insertEvent(e,t,n="PostToolUse",s,i){let a=S("sha256").update(t.data).digest("hex").slice(0,16).toUpperCase(),c=String(s?.projectDir??t.project_dir??this._getSessionProjectDir(e)).trim(),d=String(s?.source??t.attribution_source??"unknown"),u=Number(s?.confidence??t.attribution_confidence??0),h=Number.isFinite(u)?Math.max(0,Math.min(1,u)):0,p=b(i?.bytesAvoided),v=b(i?.bytesReturned),C=this.db.transaction(()=>{if(this.stmt(o.checkDuplicate).get(e,X,t.type,a))return;this.stmt(o.getEventCount).get(e).cnt>=W&&this.stmt(o.evictLowestPriority).run(e),this.stmt(o.insertEvent).run(e,t.type,t.category,t.priority,t.data,c,d,h,p,v,n,a),this.stmt(o.updateMetaLastEvent).run(e)});this.withRetry(()=>C())}bulkInsertEvents(e,t,n="PostToolUse",s,i){if(!t||t.length===0)return;if(t.length===1){this.insertEvent(e,t[0],n,s?.[0],i?.[0]);return}let a=t.map((d,u)=>{let h=S("sha256").update(d.data).digest("hex").slice(0,16).toUpperCase(),p=s?.[u],v=String(p?.projectDir??d.project_dir??this._getSessionProjectDir(e)??"").trim(),C=v===""?"":g(v),x=String(p?.source??d.attribution_source??"unknown"),D=Number(p?.confidence??d.attribution_confidence??0),ne=Number.isFinite(D)?Math.max(0,Math.min(1,D)):0,M=i?.[u],se=b(M?.bytesAvoided),oe=b(M?.bytesReturned);return{event:d,dataHash:h,projectDir:C,attributionSource:x,attributionConfidence:ne,bytesAvoided:se,bytesReturned:oe}}),c=this.db.transaction(()=>{let d=this.stmt(o.getEventCount).get(e).cnt;for(let u of a)this.stmt(o.checkDuplicate).get(e,X,u.event.type,u.dataHash)||(d>=W?this.stmt(o.evictLowestPriority).run(e):d++,this.stmt(o.insertEvent).run(e,u.event.type,u.event.category,u.event.priority,u.event.data,u.projectDir,u.attributionSource,u.attributionConfidence,u.bytesAvoided,u.bytesReturned,n,u.dataHash));this.stmt(o.updateMetaLastEvent).run(e)});this.withRetry(()=>c())}getEvents(e,t){let n=t?.limit??1e3,s=t?.type,i=t?.minPriority;return s&&i!==void 0?this.stmt(o.getEventsByTypeAndPriority).all(e,s,i,n):s?this.stmt(o.getEventsByType).all(e,s,n):i!==void 0?this.stmt(o.getEventsByPriority).all(e,i,n):this.stmt(o.getEvents).all(e,n)}getEventCount(e){return this.stmt(o.getEventCount).get(e).cnt}getEventBytesSummary(e){let t=this.stmt(o.getEventBytesSummary).get(e);return{bytesAvoided:Number(t?.bytes_avoided??0),bytesReturned:Number(t?.bytes_returned??0)}}getLatestAttributedProjectDir(e){return this.stmt(o.getLatestAttributedProject).get(e)?.project_dir||null}_getSessionProjectDir(e){try{return this.db.prepare("SELECT project_dir FROM session_meta WHERE session_id = ?").get(e)?.project_dir||""}catch{return""}}searchEvents(e,t,n,s){try{let i=e.replace(/[%_]/g,c=>"\\"+c),a=s??null;return this.stmt(o.searchEvents).all(n,i,i,a,a,t)}catch{return[]}}getSessionIdsForProject(e){try{let t=g(e);return this.db.prepare(`SELECT DISTINCT session_id
             FROM session_events
            WHERE RTRIM(REPLACE(project_dir, '\\', '/'), '/') = ?`).all(t).map(s=>s.session_id)}catch{return[]}}ensureSession(e,t){this.stmt(o.ensureSession).run(e,t)}getSessionStats(e){return this.stmt(o.getSessionStats).get(e)??null}getSessionRollup(e){let t=this.stmt(o.getSessionRollup).get(e),n=this.stmt(o.getMaxFileEdits).get(e),s=this.stmt(o.getLatestCommitMessage).get(e),i=this.getSessionStats(e),a=(t?.tool_calls??0)>0?t?.unique_files??0:0,c=t?.errors??0,d=Math.min(a,c);return{tool_calls:t?.tool_calls??0,errors:t?.errors??0,unique_tools:t?.unique_tools??0,unique_files:t?.unique_files??0,max_file_edits:n?.max_file_edits??0,has_commit:t?.has_commit??0,commit_message:s?.data??"",edit_test_cycles:d,duration_min:t?.duration_min??0,compact_count:i?.compact_count??0,sources_indexed:t?.sources_indexed??0,total_chunks:t?.total_chunks??0,search_queries:t?.search_queries??0}}incrementCompactCount(e){this.stmt(o.incrementCompactCount).run(e)}getUsageCursor(e){return this.stmt(o.getUsageCursor).get(e)?.usage_cursor??null}setUsageCursor(e,t){this.stmt(o.setUsageCursor).run(t,e)}upsertResume(e,t,n){this.stmt(o.upsertResume).run(e,t,n??0)}getResume(e){return this.stmt(o.getResume).get(e)??null}markResumeConsumed(e){this.stmt(o.markResumeConsumed).run(e)}claimLatestUnconsumedResume(e){let t=this.stmt(o.claimLatestUnconsumedResume).get(e);return t?{sessionId:t.session_id,snapshot:t.snapshot}:null}getLatestSessionId(){try{return this.db.prepare("SELECT session_id FROM session_meta ORDER BY started_at DESC LIMIT 1").get()?.session_id??null}catch{return null}}incrementToolCall(e,t,n=0){let s=Number.isFinite(n)&&n>0?Math.round(n):0;try{this.stmt(o.incrementToolCall).run(e,t,s)}catch{}}getToolCallStats(e){try{let t=this.stmt(o.getToolCallTotals).get(e),n=this.stmt(o.getToolCallByTool).all(e),s={};for(let i of n)s[i.tool]={calls:i.calls,bytesReturned:i.bytes_returned};return{totalCalls:t?.calls??0,totalBytesReturned:t?.bytes_returned??0,byTool:s}}catch{return{totalCalls:0,totalBytesReturned:0,byTool:{}}}}recordToolLedger(e,t,n,s,i){let a=Number.isFinite(s)&&s>0?Math.round(s):0,c=Number.isFinite(i)&&i>0?Math.round(i):0;try{this.stmt(o.insertToolLedger).run(e,t,n,a,c)}catch{}}getToolLedgerSummary(e){try{let t=this.stmt(o.getToolLedgerSummary).all(e),n={};for(let s of t)n[s.tool]={calls:s.calls,bytesReturned:s.bytes_returned,counterfactualBytes:s.counterfactual_bytes,bytesSaved:s.counterfactual_bytes-s.bytes_returned};return n}catch{return{}}}recordBurstEvent(e,t,n,s){let i=Number.isFinite(n)&&n>0?Math.round(n):0,a=Number.isFinite(s)&&s>=0?s:0;if(i!==0)try{this.stmt(o.insertBurstEvent).run(e,t,i,a)}catch{}}getBurstEvents(e){try{return this.stmt(o.getBurstEvents).all(e).map(n=>({workingRoot:n.working_root,callsInBurst:n.calls_in_burst,secondsSpan:n.seconds_span,createdAt:n.created_at}))}catch{return[]}}deleteSession(e){this.db.transaction(()=>{this.stmt(o.deleteEvents).run(e),this.stmt(o.deleteResume).run(e),this.stmt(o.deleteMeta).run(e),this.stmt(o.deleteToolCalls).run(e),this.stmt(o.deleteToolLedger).run(e),this.stmt(o.deleteBurstEvents).run(e)})()}pruneOrphanedToolCalls(){let e=this.db.prepare("DELETE FROM tool_calls WHERE session_id NOT IN (SELECT session_id FROM session_meta)").run();return Number(e.changes??0)}cleanupOldSessions(e=7){let t=`-${e}`,n=this.stmt(o.getOldSessions).all(t);for(let{session_id:s}of n)this.deleteSession(s);return n.length}pruneOrphanedEvents(){let e=this.db.prepare("DELETE FROM session_events WHERE session_id NOT IN (SELECT session_id FROM session_meta)").run();return Number(e.changes??0)}};export{$ as SessionDB,f as StorageDirectoryError,et as _resetWorktreeSuffixCacheForTests,re as applyMissingSessionEventsColumns,Je as clearStorageDirectoryCheckCacheForTests,Qe as describeStorageDirectorySource,nt as ensureSessionEventsSchema,Ze as ensureWritableStorageDir,ze as formatStorageDirectoryError,Ue as getWorktreeSuffix,te as hashProjectDirCanonical,ee as hashProjectDirLegacy,g as normalizeWorktreePath,Ye as resolveContentStorageDir,tt as resolveContentStorePath,qe as resolveDefaultSessionDir,rt as resolveSessionDbPath,xe as resolveSessionPath,Q as resolveSessionStorageDir,Ke as resolveStatsStorageDir};
